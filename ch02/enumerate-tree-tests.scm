; This is the same tests as ex2-28
...
(define-test (test0)
    (define empty (list))
    (check (equal? empty (enumerate-tree empty)) "should return an empty list")
)
...
(define-test (test1)
    ...
    (check (equal? expected (enumerate-tree items)) "should have returned 1 2 3 4 5")
)
...
(define-test (test1a)
    ...
    (check (equal? expected (enumerate-tree items)) "should have returned 1")
)
...
(define-test (test2)
    ...
    (check (equal? expected (enumerate-tree items)) "should have returned 1 2 3 4")
)
...
(define-test (test3)
    ...
    (check (equal? expected (enumerate-tree items)) "should have returned 1 2")
)
...
(define-test (test6)
    ...
    (check (equal? expected (enumerate-tree items)) "should have returned 1 2 3 4 5 6")
)
